...
def excel_data() -> list:
    return [
        {"Дата операции": "01.01.2022 10:00:00", "Дата платежа": "01.01.2022", "Номер карты": "1234", "Статус": "OK",
         "Сумма операции": -100, "Валюта операции": "RUB", "Сумма платежа": -100, "Валюта платежа": "RUB",
         "Кэшбэк": 5, "Категория": "Развлечения", "MCC": "5812", "Описание": "Кинотеатр", "Бонусы(включая кэшбэк)": "",
         "Округление на инвесткопилку": "", "Сумма операции с округлением": ""},
        {"Дата операции": "01.02.2022 10:00:00", "Дата платежа": "01.02.2022", "Номер карты": "1234", "Статус": "OK",
         "Сумма операции": -200, "Валюта операции": "RUB", "Сумма платежа": -200, "Валюта платежа": "RUB",
         "Кэшбэк": 10, "Категория": "Развлечения", "MCC": "5812", "Описание": "Театр", "Бонусы(включая кэшбэк)": "",
         "Округление на инвесткопилку": "", "Сумма операции с округлением": ""},
        {"Дата операции": "01.03.2022 10:00:00", "Дата платежа": "01.03.2022", "Номер карты": "1234", "Статус": "OK",
         "Сумма операции": -300, "Валюта операции": "RUB", "Сумма платежа": -300, "Валюта платежа": "RUB",
         "Кэшбэк": 15, "Категория": "Развлечения", "MCC": "5812", "Описание": "Концерт", "Бонусы(включая кэшбэк)": "",
         "Округление на инвесткопилку": "", "Сумма операции с округлением": ""},
        {"Дата операции": "01.04.2022 10:00:00", "Дата платежа": "01.04.2022", "Номер карты": "1234", "Статус": "OK",
         "Сумма операции": -400, "Валюта операции": "RUB", "Сумма платежа": -400, "Валюта платежа": "RUB",
         "Кэшбэк": 20, "Категория": "Развлечения", "MCC": "5812", "Описание": "Цирк", "Бонусы(включая кэшбэк)": "",
         "Округление на инвесткопилку": "", "Сумма операции с округлением": ""},
    ]
