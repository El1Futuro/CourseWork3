...
def transactions():
    return pd.DataFrame({
        "Номер карты": ["6067", "6067", "5690", "5690", "9012"],
        "Сумма операции": [-100, -200, -300, -400, 0]
    })
...
def test_data_cards_in_period_transactions_cards(transactions):
    ...
    expected = {
        "Кэшбэк": {"5690": 7, "6067": 3},
        "Сумма расходов": {"5690": -700, "6067": -300}
         }
    assert result[0].to_dict() == expected
